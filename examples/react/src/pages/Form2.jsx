...
export default function () {
    ...
    return (
        <form id="form2" onSubmit={handleSubmit} onChange={watchFormState} method="post" action="https://api.restful-api.dev/objects">
            ...
            <input name="name" defaultValue="No name" />
            <input name="slogan" defaultValue="No slogan" />
            ...
            <label><input type="checkbox" name="android" value="3CPO" defaultChecked />I am not a Humanoid</label>
