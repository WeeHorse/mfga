...
export default function () {
    ...
    <form id="form3" onSubmit={handleSubmit} onChange={watchFormState} method="post" action="https://api.restful-api.dev/objects">        
        ...
        <label>Number<input type="number" name="number" min="1900" max="2030" step="10" value="2020"/></label>        
        <label>Range<input type="range" name="range" value="100"/></label>
        ...
        <fieldset>     
            ...
            <label>Date<input type="date" name="date" value="2023-05-08"/></label>
            <label>Time<input type="time" name="time" value="09:20"/></label>
            <label>Date and time<input type="datetime-local" name="datetime" value="2023-05-08 09:20"/></label>        
        ...
        <label>This field should be ignored in the post data and in the dirty check<input type="text" value="Missing name attribute"/></label>  
