...
export default function () {
    ...
    return (
        <form id="form1" onSubmit={handleSubmit} onChange={watchFormState} method="post" action="https://api.restful-api.dev/objects">
            ...
            <select name="foo-or-bar" defaultValue="foo">
            ...
            <select name="multiple-pre-selected-options" multiple defaultValue={['pigs', 'in']}>
                <option value="pigs">Pigs</option>
                <option value="in">In</option>
                <option value="a">A</option>
                <option value="blanket">Blanket</option>
            ...
            <label><input type="checkbox" name="robot" value="true" defaultChecked />I am a Robot</label>
